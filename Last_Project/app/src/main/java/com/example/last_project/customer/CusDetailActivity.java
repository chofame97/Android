        ...
        btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(edt_name.getText().toString().length() < 1){
                    Toast.makeText(CusDetailActivity.this, "이름 입력하셈", Toast.LENGTH_SHORT).show();
                    return ;
                }
                Gson gson = new Gson();
                dto.setName(edt_name.getText().toString());
                ...
                CommonMethod.executeAskGet(task); // true false / 1,0
                // finish(); // 테스트가 올바르게 끝나고 나서 실행
            }
        });
